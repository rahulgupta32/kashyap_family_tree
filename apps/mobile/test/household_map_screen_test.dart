...
void main(){
 testWidgets('Mocked map HTTP flow withdraws consent and reloads generalized locations',(tester)async{
  ...
  await tester.scrollUntilVisible(find.text('Withdraw map consent'),200,scrollable:find.byWidgetPredicate((w)=>w is Scrollable && w.axisDirection==AxisDirection.down));await tester.tap(find.text('Withdraw map consent'));await tester.pumpAndSettle();
